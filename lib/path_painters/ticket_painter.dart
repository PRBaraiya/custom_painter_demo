...
class TicketPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path_3.quadraticBezierTo(size.width * 0.9750000, size.height * 0.8500000,
        size.width * 0.9750000, size.height * 0.9);
    path_3.quadraticBezierTo(size.width * 0.97235, size.height * 0.9500750,
        size.width * 0.9375, size.height * 0.95);
    path_3.lineTo(size.width * 0.7, size.height * 0.95);
    path_3.quadraticBezierTo(size.width * 0.6735875, size.height * 0.955675,
        size.width * 0.675, size.height * 0.9);
    path_3.cubicTo(size.width * 0.675, size.height * 0.7, size.width * 0.675,
        size.height * 0.3, size.width * 0.675, size.height * 0.1);
    path_3.cubicTo(
        size.width * 0.6773875,
        size.height * 0.0457,
        size.width * 0.6879625,
        size.height * 0.051275,
        size.width * 0.7125,
        size.height * 0.05);
    path_3.close();
